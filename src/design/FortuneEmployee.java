...
public class FortuneEmployee {
	...
	public static void main(String[] args) {
		...
		EmployeeInfo employee = new EmployeeInfo("OVI AHMED", 01);
		EmployeeInfo.setCompanyName("NBA");
		employee.setSalary(100000);
		employee.setSsn("111.111.1111");
		employee.setEmployeeId(01);
		employee.setEmail("oviahmed7@gmail.com");
		employee.setDate_of_birth("10/25/1995");
